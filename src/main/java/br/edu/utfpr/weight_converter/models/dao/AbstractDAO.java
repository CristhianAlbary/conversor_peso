package br.edu.utfpr.weight_converter.models.dao;
...
import br.edu.utfpr.weight_converter.util.JPAUtil;
...
public class AbstractDAO<PK, T> {
    ...
    public List<T> findLastFive() {
        String queryString = "SELECT o FROM " + getTypeClass().getName() + " o ORDER BY o.id DESC ";
    ...
    public List<T> findByName(String firstPropertyName, Object name) {
        String queryString = "SELECT o FROM " + getTypeClass().getName() + " o where o." + firstPropertyName + " = :param";
